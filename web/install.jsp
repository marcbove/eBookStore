...
private List<String> resetDatabase(boolean force) throws Exception {
        ...
        */
        ...
        String data[] = new String[]{
            ...
            "INSERT INTO " + dbname + ".BOOK(RATING, DESCRIPTION, PRICE, NAME, AUTHOR, STOCK) VALUES (5, 'This is a description', 10.0, 'Watchmen', 'Alan Moore, Dave Gibbons', 50)",
            "INSERT INTO " + dbname + ".BOOK(RATING, DESCRIPTION, PRICE, NAME, AUTHOR, STOCK) VALUES (4, 'This is a description', 25.0, 'Sherlock Holmes Complete', 'Arthur Conan Doyle', 38)",
            "INSERT INTO " + dbname + ".BOOK(RATING, DESCRIPTION, PRICE, NAME, AUTHOR, STOCK) VALUES (3, 'This is a description', 30.0, 'A Song of Fire and Ice', 'George R.R. Martin', 75)"
        };
